...
/*   Updated: 2022/09/06 13:55:32 by pprussen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Finds the export string in str
 * 
 * @param var [t_var *]
 * @param cmd [t_cmd *]
 * @param str [char *]
 * @return int TRUE if export is in str, else FALSE
 */
static int	find_export(t_var *var, t_cmd *cmd, char *str)
{
	int	i;
...
void	find_inbuilts(t_var *var, t_cmd *cmd, char *str)
{
	...
	if (find_export(var, cmd, str) == TRUE)
		;
